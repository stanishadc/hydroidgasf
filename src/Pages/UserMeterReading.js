...
export default function UserMeterReading() {
  var date = new Date();
  ...
  const GetBarGraphData = (data) => {
    axios
      .get(
        APIConfig.APIACTIVATEURL +
          APIConfig.GETUSERBARGRAPHDATEWISE +
          "?DateFrom=" +
          moment(fromDate).format("YYYY-MM-DD") +
          "&DateTo=" +
          moment(toDate).format("YYYY-MM-DD") +
          ...
          <div className="container-fluid">
              ...
              <div className="col-lg-12">
                <div className="card">
                  <div className="card-header">
                    <h5 className="card-title mb-0">Gas Usage Data</h5>
                  </div>
                          ...
                          {meterReading === undefined
                            ...
                            : meterReading.map((mr, index) => (
                                <tr key={mr.id}>
                                  <td>{index + 1}</td>
                                  <td>
                                    {moment(mr.time).format("MMM Do YYYY")}
                                  </td>
                                  <td>{mr.deviceId}</td>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="card">
                  <div className="card-header">
                    <h5 className="card-title mb-0">Gas Consumption</h5>
                  </div>
