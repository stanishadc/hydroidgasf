...
export default function TicketDetails() {
    ...
    const applicationAPI = () => {
        return {
            create: (newrecord) =>
                axios.post(APIConfig.APIACTIVATEURL + APIConfig.CREATETICKETRESPONSE, JSON.stringify(newrecord), { ...headerconfig }),
            update: (updateRecord) =>
                axios.put(APIConfig.APIACTIVATEURL + APIConfig.UPDATEDEVICE, updateRecord),
            delete: (id) => axios.delete(APIConfig.APIACTIVATEURL + APIConfig.DELETETICKETRESPONSE + "/" + id, { ...headerconfig })
        };
    };
    ...
    const GetTicketReplies = () => {
        axios
            .get(APIConfig.APIACTIVATEURL + APIConfig.GETTICKETRESPONSEBYID+ "?TicketId=" + ticketId, { ...headerconfig })
            .then((response) => {
    ...
    const GetTicketDetails = () => {
        axios
            .get(APIConfig.APIACTIVATEURL + APIConfig.GETTICKETBYID + "/" + ticketId, { ...headerconfig })
            .then((response) => {
