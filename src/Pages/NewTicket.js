...
export default function NewTicket() {
    ...
    const applicationAPI = () => {
        return {
            create: (newrecord) =>
                axios.post(APIConfig.APIACTIVATEURL + APIConfig.CREATETICKET, JSON.stringify(newrecord), { ...headerconfig }),
            update: (updateRecord) =>
                axios.put(APIConfig.APIACTIVATEURL + APIConfig.UPDATETICKET, updateRecord),
            delete: (id) => axios.delete(APIConfig.APIACTIVATEURL + APIConfig.DELETETICKET + "/" + id, { ...headerconfig })
        };
    };
    ...
    const GetTicketCategories = () => {
        axios
            .get(APIConfig.APIACTIVATEURL + APIConfig.GETALLTICKETCATEGORIES, { ...headerconfig })
            .then((response) => {
    ...
    const GetTickets = (number) => {
        axios
            .get(APIConfig.APIACTIVATEURL + APIConfig.GETTICKETBYUSER + "/" + localStorage.getItem("userId") + "?pageNumber=" + number + "&pageSize=" + pageSize + "", { ...headerconfig })
            .then((response) => {
                                ...
                                <div className="row">
                                    <div className="col-lg-3">
                                        <div className="mb-4">
                                            ...
                                            <select name="ticketCategoryId" value={values.ticketCategoryId} onChange={handleInputChange} className={"form-control" + applyErrorClass('ticketCategoryId')}>
                                    ...
                                    <div className="col-lg-3">
                                        <div className="mb-4">
                                            ...
                                            <select name="ticketPriority" value={values.ticketPriority} onChange={handleInputChange} className={"form-control" + applyErrorClass('ticketPriority')}>
