  ...
  return (
    <div className="auth-page-wrapper pt-5">
      <div className="auth-one-bg-position">
        <img
          src="/assets/images/loginHero.jpg"
          alt="login"
        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div className="col-md-8 col-lg-6 col-xl-5">
              <div className="card loginBox mt-4">
                <div className="card-body p-4">
                  <div className="text-center mb-4 text-white-50">
                    <div>
                      <h1 className="loginHeading"> HYDROID </h1>
                    </div>
                    <p className="loginCaption">SMART METERING SOLUTIONS</p>
                  </div>
                  <div className="text-center mt-2 loginSeparation">
                      ...
                      <div className="mt-4 text-center">
                        <div className="signin-other-title">
                          <p className="mb-0">
                            ...
                            <Link
                              onClick={() =>
                                (window.location = 'mailto:support@hydroid.in')
                              }
